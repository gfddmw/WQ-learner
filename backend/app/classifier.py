...
KEYWORD_MAP: dict[str, dict[str, list[str]]] = {
    "数据结构": {
        "树与二叉树": ["数据结构", "树", "二叉树", "遍历", "b树", "b-tree"],
        "查找与散列": ["哈希", "散列", "查找", "hash"],
        "图": ["图", "最短路径", "拓扑", "dfs", "bfs"],
        "排序": ["排序", "快排", "归并", "堆排序"],
    },
    "计算机组成原理": {
        "存储系统": ["计算机组成原理", "cache", "缓存", "主存", "存储", "页表"],
        "指令系统": ["指令", "寻址", "alu", "操作数"],
        "CPU": ["流水线", "周期", "中断", "控制器", "cpu"],
    },
    "操作系统": {
        "进程管理": ["操作系统", "进程", "线程", "调度", "信号量", "死锁"],
        "内存管理": ["虚拟内存", "页面", "缺页", "置换", "内存"],
        "文件系统": ["文件", "目录", "磁盘"],
    },
    "计算机网络": {
        "传输层": ["计算机网络", "tcp", "udp", "拥塞", "滑动窗口", "可靠传输"],
        "网络层": ["ip", "路由", "子网", "icmp"],
        "应用层": ["http", "dns", "smtp"],
    },
    "高等数学": {
        "极限与连续": ["高等数学", "极限", "连续", "间断点", "无穷小", "泰勒"],
    ...
    "线性代数": {
        "行列式": ["线性代数", "行列式", "逆序数", "余子式"],
        "矩阵": ["矩阵", "逆矩阵", "伴随", "秩", "初等变换"],
        "向量": ["向量组", "线性相关", "线性无关", "极大无关组", "向量"],
        "线性方程组": ["线性方程组", "克拉默", "基础解系"],
        "特征值与特征向量": ["特征值", "特征向量", "相似", "对角化"],
        "二次型": ["二次型", "合同", "正定"],
    },
    "概率统计": {
        "随机事件与概率": ["概率统计", "概率", "随机事件", "贝叶斯", "条件概率"],
        "随机变量及其分布": ["随机变量", "分布函数", "密度函数", "泊松", "正态分布"],
        "多维随机变量": ["二维随机变量", "边缘分布", "独立性", "协方差", "多维"],
